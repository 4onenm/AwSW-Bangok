...
label bangok_four_bryce1_f_tonguefuck:
    ...
    if persistent.bangok_watersports == True:
        ...
        Br flirty dk "My tongue might even fit up there. Mind if I...?"
    ...
    menu:
        "I'm never getting tongue from a human again.":
            Br stern dk "What? What's wrong?"
            c "That... that was incredible."
            $ brycemood += 1
            Br flirty dk "Oh."
            $ renpy.pause (0.5)
            Br smirk dk "You going to be able to get up?"
    ...
    Br smirk dk "Now, I believe it's my turn?"
...
label bangok_four_bryce1_m:
    ...
    if persistent.bangok_balls:
        ...
        Br smirk dk "So your parts just hang out like that? Undefended? With that limp shaft?"
    else:
    ...
    show bryce at center with ease
    if persistent.bangok_balls:
        Br normal dk "Never seen things... just always outside like that. Dry skin tastes weird too."
    else:
        ...
        "I want to taste you.":
            ...
            menu:
                "Suction.":
                    ...
                    Br flirty dk "Guess not. But I'd like to feel it again."
                "You'll find out.":
                    $ brycemood += 1
