...
label bangok_four_xkatsu_wait:
    ...
    if bangok_four_bangnokay or persistent.bangok_four_bangnokay:
        ...
        menu:
            "Can't I help?":
                Ka normal "What? Help? You figured out what I'd be doing, didn't ya?"
                c "Yeah, that's why I--"
                Ka exhausted "That's a thing I do on my own, human. No friends-with-benefits nonsense like the youngin's get up to."
                c "Oh."
                Ka "Now shoo. Shoo! Give me a bit of privacy, will ya?"
            "Sure thing.":
                pass
    else:
...
label bangok_four_xkatsu_underneath_ass:
    ...
    if bangok_four_xkatsu.flavor == 3:
        ...
        menu:
            ...
            "Uh-":
                $ bangok_four_xkatsu.flavor = 2
    stop soundloop fadeout 0.5
    show katsu normal at Position(xpos=0.53, ypos=1.0) with ease
    ...
    play sound "fx/snarl.ogg"
    show katsu normal at Position(xpos=0.5, ypos=1.0) with ease
...
label bangok_four_xkatsu_underneath_vag:
    ...
    if bangok_four_xkatsu.flavor == 3:
        ...
        menu:
            ...
            "Uh-":
                $ bangok_four_xkatsu.flavor = 2
    stop soundloop fadeout 0.5
    show katsu normal at Position(xpos=0.52, ypos=1.0) with ease
    ...
    if bangok_four_xkatsu.fill == 2:
        ...
        if persistent.bangok_inflation == True:
            ...
            m "He was spot on, the inner bucket filling alarmingly quickly."
        Ka exhausted "Ha! G-Gotta switch, can't overfill 'em!"
        show katsu normal at Position(xpos=0.50, ypos=1.0) with ease
        m "Ducking back under Katsuharu, I pulled the first bucket aside and the second bucket into the line of fire."
        jump bangok_four_xkatsu_fill3
...
label bangok_four_xkatsu_ready:
    ...
    if bangok_four_xkatsu.fill == 0:
        ...
        menu:
            "You made it in the bucket you came in?" if not (bangok_four_bangnokay or persistent.bangok_four_bangnokay):
