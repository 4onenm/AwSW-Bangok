label bangok_four_adine4_shower_purring:
    ...
    $ renpy.pause (0.5)
    m "It took me a moment to process what she asked. But then it hit me."
    ...
    c "Not a problem, it'll be my first time getting it, so you'll be the best I've ever head."
    ...
    m "As the water pattered down around us, soaking us both to the bone, I came close to climax. Whatever tips she'd been reading were paying off it seemed."
    m "I reached a hand out to gently stroke her head, letting her know I was having fun."
    m "At the same time however, was ready to bust, and Adine knew it. It was only a matter of seconds."
    ...
    c "Thanks, that's the best blowjob I've ever had."
    ...
    scene adineapt2 at Pan ((128, 300), (128,300), 0.0) with dissolvemed
    play soundloop "fx/shower.ogg" fadein 1.0
    m "I found the smallest towel I could find, which was still big enough to be a blanket for me, and dried myself off before stepping aside to wait for Adine to finish up."
    stop soundloop fadeout 2.0
    jump bangok_four_adine4_when_she_turned_off_the_water_again